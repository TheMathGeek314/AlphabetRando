...
namespace AlphabetRando {
    internal static class CondensedSpoilerLogger {
        ...
        public static void AddCategory(string categoryName, Func<LogArguments, bool> test, List<string> entries) => CSLImport.AddCategory?.Invoke(categoryName, test, entries);
    }
}
